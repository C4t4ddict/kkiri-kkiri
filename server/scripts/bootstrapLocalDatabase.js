...
const run = async () => {
  ...
  try {
    ...
    const activities = [
      [1, '2026 대학생 AI 서비스 해커톤', '전국 대학생', '한국AI협회', '서울 코엑스', -20, 45, -14, 24, '대상 500만원, 최우수상 200만원', '생성형 AI로 캠퍼스 문제를 해결하는 서비스를 만듭니다.', '공모전', 'IT·AI'],
      [2, '지역문제 해결 UX 챌린지', '대학생 및 대학원생', '서울디자인재단', '온라인·서울', -10, 60, -7, 35, '총상금 1,000만원', '지역 생활 문제를 리서치하고 서비스 경험으로 제안합니다.', '공모전', '기획·디자인'],
      [3, '오픈소스 메이커톤 2026', '개발·디자인 직군 대학생', '오픈소스커뮤니티', '판교', -5, 50, -3, 28, '우수팀 장비 및 후속 개발비', '공개 API와 오픈소스를 활용해 작동하는 제품을 완성합니다.', '해커톤', '개발'],
      [4, '대학생 데이터 분석 경진대회', '데이터 분석에 관심 있는 대학생', '데이터산업진흥원', '온라인', -25, 70, -12, 18, '대상 300만원', '공공 데이터를 활용해 사회 현상을 분석하고 해결책을 제시합니다.', '공모전', '데이터'],
      [5, '소셜 임팩트 콘텐츠 캠프', '콘텐츠 제작에 관심 있는 청년', '임팩트스퀘어', '서울 성수', 5, 40, 1, 30, '제작비 지원 및 우수작 상영', '사회 문제를 알기 쉬운 숏폼 콘텐츠로 제작합니다.', '대외활동', '콘텐츠'],
      [6, '캠퍼스 창업 아이디어 리그', '예비 창업 대학생', '청년창업재단', '대전', -30, 90, -20, 42, '사업화 지원금 최대 1,000만원', '대학생의 일상에서 출발한 창업 아이디어를 검증합니다.', '공모전', '창업'],
    ];

    for (const [id, title, target, organizer, location, operationStart, operationEnd, applicationStart, applicationEnd, prize, details, category, topic] of activities) {
      await connection.execute(
