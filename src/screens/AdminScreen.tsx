...
const styles = StyleSheet.create({
  ...
  errorCard: { marginBottom: 8, padding: 14, borderWidth: 1, borderColor: '#E4E7EC', borderRadius: 12, backgroundColor: '#FFFFFF' },
  ...
  previousReply: { marginTop: 8, padding: 10, borderWidth: 1, borderColor: '#E4E7EC', borderRadius: 10, backgroundColor: colors.primarySurface },
