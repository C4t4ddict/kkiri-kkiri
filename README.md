...
활동 탭의 **우리 팀 활동 시작**에서 공고 없이 팀을 만들거나, 기존 활동의 **공동 작업·기여 기록**으로 들어갑니다. 초대 링크로 합류하고, 문서에서 담당 작업을 만든 뒤 결과물과 본인의 기여를 연결할 수 있습니다.

- 기여 기록은 활동 중에도 개인 포트폴리오 초안에 표시됩니다.
- 팀원 확인은 선택 사항이며, 기여 내용을 고치면 기존 확인은 초기화됩니다.
- 마감일만 지났다는 이유로 자동 보관하지 않습니다. 팀장이 마무리 단계를 거쳐 보관하며 문서·기여·회고·평가는 이후에도 이용할 수 있습니다.
- 공개할 기록을 선택해 미리보기를 확인한 뒤 공유 링크 또는 PDF를 만듭니다. 내부 문서 본문과 다른 팀원의 평가를 자동 공개하지 않습니다.
- 공개본은 게시 시점의 스냅샷입니다. 다시 게시하면 이전 링크가 해제되며, 공유 해제도 가능합니다.
- 모집글 지원 시 본인이 공유한 포트폴리오를 선택해 지원 내용에 링크를 넣을 수 있습니다.

API·보안 정책과 검증 범위는 [팀 활동 흐름 변경 기록](docs/changes/team-journey.md)을 참고하세요.
