...
type AdminActivity = { activity_id: number; title: string; organizer?: string; main_image_url?: string; source_name?: string; source_url?: string; quality_score?: number; is_hidden: number };
